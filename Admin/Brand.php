...
<script>
    function Supprimer(id) {
        if (confirm('Confirmez-vous cette action?')) {
            document.location.href = "page_js/supprimerbrand.php?ID=" + id;
        }
    }

    function Archiver(id) {
        if (confirm('Confirmez-vous cette action?')) {
            document.location.href = "page_js/archiverbrand.php?ID=" + id;
        }
    }

    function Unarchiver(id) {
        if (confirm('Confirmez-vous cette action?')) {
            document.location.href = "page_js/unarchiverbrand.php?ID=" + id;
        }
    }
</script>
<?php
...
if (isset($_POST["save"])) {
    ...
    if ($id == "0") {
        $sql = "INSERT INTO `gestsells_brand`(`brand`,`origine`,`archive`) VALUES ('" . $brand . "','" . $origine . "','0')";
...
$brand = "";
$origine = "";
$req = "select * from gestsells_brand where id=" . $id;

while ($enreg = mysqli_fetch_array($query)) {
    $brand = $enreg["brand"];
    $origine = $enreg["origine"];
}
?>
<!-- /header-dashboard -->
<!-- main-content -->
                                ...
                                <form class="form-style-1" action="" method="POST">
                                    <div class="gap22 cols">
                                        <fieldset class="name mb-24">
                                            ...
                                            <input class="flex-grow border-primary" type="text" value="<?php echo $brand ?>"
                                                name="brand" tabindex="0" aria-required="true" required="">
                                        </fieldset>
                                        <fieldset class="name mb-24">
                                            <div class="body-title">origine<span class="tf-color-1">*</span></div>
                                            <input class="flex-grow border-primary" type="text" value="<?php echo $origine ?>"
                                                name="origine" tabindex="0" aria-required="true" required="">
                                        </fieldset>
                                    </div>
                                    <div class="bot">
                                        <div></div>
                ...
                <h3>List des Brands</h3>
                    <div class="wg-table table-all-roles" style="overflow-x: visible !important;">
                        <ul class="table-title flex gap20 mb-14">
                            ...
                            <li>
                                <div class="body-title">Origine</div>
                            </li>
                            <li>
                        ...
                        <ul class="flex flex-column">
                            <?php
                            $req = "select * from gestsells_brand";
                            ...
                            ?>
                                <li class="roles-item">
                                    ...
                                    <div class="body-text"><?php echo $brand ?></div>
                                    <div class="body-text"><?php echo $origine ?></div>
                                    ...
                                    <div class="list-icon-function">
                                        ...
                                        <div class="item">
                                            <a href="./page_js/supprimerbrand.php?ID=<?php echo $id; ?>"><i
