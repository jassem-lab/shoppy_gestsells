...
<script>
    function Supprimer(id) {
        if (confirm('Confirmez-vous cette action?')) {
            document.location.href = "page_js/supprimercategory.php?ID=" + id;
        }
    }

    function Archiver(id) {
        if (confirm('Confirmez-vous cette action?')) {
            document.location.href = "page_js/archivercategory.php?ID=" + id;
        }
    }

    function Unarchiver(id) {
        if (confirm('Confirmez-vous cette action?')) {
            document.location.href = "page_js/unarchivercategory.php?ID=" + id;
        }
    }
</script>
<?php
...
if (isset($_POST["save"])) {
    ...
    if ($id == "0") {
        $sql = "INSERT INTO `gestsells_category`(`category`,`archive`) VALUES ('" . $category . "','0')";
...
$req = "select * from gestsells_category where id=" . $id;
                                ...
                                <form class="form-style-1" action="" method="POST">
                                    <div class="gap22 cols">
                                        <fieldset class="name mb-24">
                                            ...
                                            <input class="flex-grow border-primary" type="text" value="<?php echo $category ?>"
                                                name="category" tabindex="0" aria-required="true" required="">
                                        </fieldset>
                ...
                <h3>List des Categories</h3>
                    <div class="wg-table table-all-roles" style="overflow-x: visible !important;">
                        ...
                        <ul class="flex flex-column">
                            <?php
                            $req = "select * from gestsells_category";
                            ...
                            ?>
                                <li class="roles-item">
                                    ...
                                    <div class="body-text"><?php echo $category ?></div>
                                    ...
                                    <div class="list-icon-function">
                                        ...
                                        <?php } ?>
                                        <div class="item">
                                            <a href="./page_js/supprimercategory.php?ID=<?php echo $id; ?>"><i
