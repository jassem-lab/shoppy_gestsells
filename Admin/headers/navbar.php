...
<?php
$profil = "";
$req = "select * from gestsells_profils where id=" . $_SESSION['idprofil'];
...
<?php
$gender = "";
$reqg = "select * from gestsells_users where id=" . $_SESSION['idutilisateur'];
$queryg = mysqli_query($con, $reqg);
while ($enregg = mysqli_fetch_array($queryg)) {
    $gender = $enregg['gender'];
}
?>
<?php
$logo = "";
$reql = "select * from gestsells_soc where id=1";
$queryl = mysqli_query($con, $reql);
while ($enregl = mysqli_fetch_array($queryl)) {
    $logo = $enregl["logo"];
}
?>
...
<head>
    ...
    <title>JCoding - Gestion Commerciale</title>
                ...
                <div class="section-menu-left">
                    <div class="box-logo">
                        <a href="index.php" id="site-logo-inner">
                            <img class="" id="" alt="" style="width : 100px !important" src="../assets/images/<?php echo $logo ?>"
                               >
                        </a>
                            ...
                            <ul class="menu-list">
                                <li class="menu-item has-children active">
                                    <a href="javascript:void(0);" class="menu-item-button">
                                        ...
                                        <div class="text">Paramètrage</div>
                                    </a>
                                    <ul class="sub-menu" style="display: block;">
                                        <li class="sub-menu-item">
                                            <a href="./parametrage.php" class="">
                                                <div class="text">Paramètrage</div>
                                            </a>
                                        </li>
                                        <li class="sub-menu-item">
                                            <a href="./taxe.php" class="">
                                                <div class="text">Taxe</div>
                                            </a>
                                        </li>
                                        <li class="sub-menu-item">
                                            <a href="./societe.php" class="">
                                                <div class="text">Société</div>
                                            </a>
                                        </li>
                                        <li class="sub-menu-item">
                                            <a href="./profils.php" class="">
                                                <div class="text">Profils</div>
                                            </a>
                                        </li>
                                        <li class="sub-menu-item">
                                            <a href="./utilisateurs.php" class="">
                                        ...
                                        <li class="sub-menu-item">
                                            <a href="./sizes.php" class="">
                                                <div class="text">Tailles</div>
                                            </a>
                                        </li>
                                        <li class="sub-menu-item">
                    ...
                    <div class="bot text-center">
                        <div class="wrap">
                            ...
                            <div class="mb-20">
                                ...
                                <div class="text">Contact us if you have any assistance, we will contact you as soon as
                                    possible</div>
                            </div>
                    ...
                    <div class="header-dashboard">
                        <div class="wrap">
                            <div class="header-left">
                                <a href="./index.php">
                                    <img class="" id="logo_header_mobile" alt="" style="width : 100px !important" src="../assets/images/<?php echo $logo ?>"
                                      >
                                </a>
                                <div class="button-show-hide">
                                    <i class="icon-menu-left"></i>
                                        ...
                                        <button class="btn btn-secondary dropdown-toggle" type="button"
                                            ...
                                            <span class="header-user wg-user">
                                                <span class="image">
                                                    <?php
                                                    if ($gender !== "male") {
                                                        echo '<img src="images/avatar/user.png" alt="">"';
                                                    } else {
                                                        echo '<img src="images/avatar/user1.png" alt="">"';
                                                    }
                                                    ?>

                                                </span>
                                                <span class="flex flex-column">
                                                    <span class="body-title mb-2"><?php echo $_SESSION['user'] ?> |
                                                        <span class="text-tiny"> <?php echo $profil ?></span></span>
                                                </span>
                                            </span>
                                        </button>
