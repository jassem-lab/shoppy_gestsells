...
if (isset($_POST["save"])) {
    ...
    echo  $sql = "UPDATE `gestsells_parametres`SET `exercice`='" . $exercice . "' WHERE id = 1 ";
                            ...
                            <div class="col-3 mb-20">
                                <form class="form-style-1" action="" method="POST">
                                    <fieldset class="name mb-24">
                                        <div class="body-title">Exercice<span class="tf-color-1">*</span></div>
                                        <input class="flex-grow border-primary" type="text" value="<?php echo $exercice ?>" name="exercice"
